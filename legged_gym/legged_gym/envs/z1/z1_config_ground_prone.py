...
class Z1Cfg( LeggedRobotCfg ):
    class init_state( LeggedRobotCfg.init_state ):
        pos = [0.0, 0.0, 0.50]  # Z1初始高度应该更高，因为它本身就更高
    ...
    class control( LeggedRobotCfg.control ):
        ...
        action_scale = 0.5  # Z1肢体更长，可能需要更大的动作幅度
    ...
    class asset( LeggedRobotCfg.asset ):
        ...
        left_leg_joints = ['left_hip_yaw_joint', 'left_hip_pitch_joint', 'left_hip_roll_joint', 'left_knee_joint', 'left_ankle_pitch_joint', 'left_ankle_roll_joint']
        right_leg_joints = ['right_hip_yaw_joint', 'right_hip_pitch_joint', 'right_hip_roll_joint', 'right_knee_joint', 'right_ankle_pitch_joint', 'right_ankle_roll_joint']
    ...
    class rewards( LeggedRobotCfg.rewards ):
        ...
        base_height_target = 0.70  # Z1总高度的~70%
    ...
    class constraints( LeggedRobotCfg.rewards ):
        ...
        target_base_height = 0.35  # Z1爬起初期目标
